 <section id="SERVICE" class="services" >
    <div class="container">
      ...
      <div class="heading wow fadeInUp" data-wow-duration="100ms" data-wow-delay="100ms">
        <div class="row">
        ...
        <div class="row">
          <div class="col-sm-4 wow fadeInDown socka" data-wow-duration="100ms" data-wow-delay="200ms">
            ...
            <div class="service-info">
              ...
              <p>Identité visuelle /  Charte graphique  /  Webdesign  <br></p>
            </div>
          </div>
          ...
          <div class="col-sm-4 wow fadeInDown socka" data-wow-duration="100ms" data-wow-delay="350ms">
            ...
            <div class="service-info">
              <h3>WEB MARKETING</h3>
              <p>Référencement naturel(SEO) / Référencement payant(SEM)  / Community Management </p>
            </div>
          </div>
