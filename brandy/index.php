...
============================== -->
 ...
 <!--<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script>-->
    ...
    <script type='text/javascript'>function init_map(){var myOptions = {zoom:12,scrollwheel: false,center:new google.maps.LatLng(48.821925, 2.421708),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(48.821925, 2.421708)});infowindow = new google.maps.InfoWindow({content:'<strong>APP AND GO</strong><br>19 Rue Adrien Damalix, 94410 Saint-Maurice<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
